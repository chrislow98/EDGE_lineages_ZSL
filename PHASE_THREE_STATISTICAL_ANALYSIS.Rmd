...
correlations <- cor(ePD_response_df[,2:23])
...
m <- lmer(log(median_EDGE +1) ~ log(Gen_length_days +1)  + threat_sum + prop_2_1 + prop_2_3 + prop_5_1 + prop_5_3 + prop_8_1 + (1 | Order), data = ePD_response_df)
