...
### create tabular format or results
tab_model(file = "EDGE_glmm_table.html",
  EDGE_glmm_full,
  CSS = list(
    css.depvarhead = 'color: black;',
    css.centeralign = 'text-align: left;', 
...
tab_model(file = "EDGE_ED_glmm_table.html",
...
MuMIn::r.squaredGLMM(con_status_uplisted_glmm_EDGE)
...
### create tabular format or results
tab_model(file = "con_status_uplisted_glmm_EDGE.html",
  con_status_uplisted_glmm_EDGE,
  show.est = TRUE, 
  string.est = "Estimate", 
  transform = NULL, 
  digits = 4,
...
MuMIn::r.squaredGLMM(pop_status_dec_glmm_EDGE)

# check model performance
check_model(pop_status_dec_glmm_ED)

### create tabular format or results
tab_model(file = "pop_status_dec_glmm_ALL.html",
