...
# Remove DD species from RL analysis
...
IUCN_RL_status_combined <- subset(IUCN_RL_status_combined, select=c(taxonid,scientific_name, category, family, Family, X2008.RL.cat, RL_change))
...
save(RL_change_df, redlist_status, file = "C:/Users/Student/Zoological Society of London/EDGEofExistence - Chris Low - EDGE lineages/Project II/Data and analysis/Monitoring_population_trends/RL_population_trend_data_final.RData")
...
# join up threat dataframe with names
t <- left_join(names, redlist_threats, by = c("taxonid" = "species"))
