...
# load this data (raw): redlist_status, redlist_threats, Generation_length, Pantheria, mammals_pd_merged, IUCN_RL_status_combined, conservation_actions
...
# Get mean body size for each family - using Pacifici et al. (2013) dataset
...
# Scrap code? SAVE NEW PRIORITY DATAFRAME AND MAMMALS_PD_MERGED
