...
sum(lengths(regmatches(IUCN_pop_trend$populationTrend, gregexpr("Increasing", IUCN_pop_trend$populationTrend))))

sum(lengths(regmatches(IUCN_pop_trend$populationTrend, gregexpr("Stable", IUCN_pop_trend$populationTrend))))
