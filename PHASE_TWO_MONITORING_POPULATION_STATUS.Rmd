...
redlist_status <- do.call(rbind,lapply(spp,FUN=function(sp){rl_search(sp, key= apikey)$result}))
...
IUCN_RL_status_combined$X2008.RL.cat[IUCN_RL_status_combined$X2008.RL.cat == "DD"] <- NA
...
IUCN_RL_status_combined$redlistCategory[IUCN_RL_status_combined$redlistCategory == "DD"] <- NA
