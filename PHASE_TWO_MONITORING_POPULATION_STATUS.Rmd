...
library(litserchr) # pull out conservation measures from text
...
# extract key conservation action terms
key_con_terms <- extract_terms(text=conservation_actions[, "conservationActions"], method="fakerake", min_freq=100, min_n=2, max_n = 9)
...
trait$EUFG[trait$Species == "Rutilus_rutilus"] <- "Fw"
trait$EUFG[trait$Species == "Abramis_brama"] <- "Fw"
