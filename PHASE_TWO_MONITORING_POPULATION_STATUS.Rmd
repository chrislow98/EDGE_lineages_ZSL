...
load("C:/Users/Student/Zoological Society of London/EDGEofExistence - Chris Low - EDGE lineages/Project II/Data and analysis/Monitoring_population_trends/IUCN_api_data.RData")
...
# Put species name first
redlist_threats <- redlist_threats[,c(9, 1:8)]

# Select columns 1-4
redlist_threats <- redlist_threats[c(1:4)]
...
save(redlist_threats, mammals_IUCN_full, redlist_status, file = "C:/Users/Student/Zoological Society of London/EDGEofExistence - Chris Low - EDGE lineages/Project II/Data and analysis/Monitoring_population_trends/IUCN_api_data.RData")
...
t <- rl_measures(name = 'Cerdocyon thous', key = apikey)
