...
# Join EDGE mammal dataframe with IUCN data extracted dataframe
redlist_status <- EDGE_mammals %>% 
  left_join(redlist_status, by = c("RL.ID" = "taxonid"))
...
save(redlist_threats, mammals_IUCN_full, file = "C:/Users/Student/Zoological Society of London/EDGEofExistence - Chris Low - EDGE lineages/Project II/Data and analysis/Monitoring_population_trends/IUCN_api_data.RData")
