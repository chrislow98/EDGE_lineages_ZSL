...
EDGE_priority_lineages$priority_type[EDGE_priority_lineages$unassessed_prop > 0.5 & EDGE_priority_lineages$assessed_threat_prop == 1]<- "Watchlist lineage"

EDGE_priority_lineages$priority_type[EDGE_priority_lineages$priority_type == "NA"] <- "Boarderline lineage"

# Get lengths of each priority lineage list 
sum(lengths(regmatches(EDGE_priority_lineages$priority_type, gregexpr("Priority lineage", EDGE_priority_lineages$priority_type))))

# Either save/ load FINAL bits of data for everything mammal phylogeny related
save(family.iter,EDGE_priority_lineages, ex_PD_full, mammal.trees.full, mammal.trees.upham, data_out, data_out_upham, file =  "C:/Users/Student/Zoological Society of London/EDGEofExistence - Chris Low - EDGE lineages/Project II/Data and analysis/Mammal phylogenies/ALL_mammal_phylogeny_data.RData")
