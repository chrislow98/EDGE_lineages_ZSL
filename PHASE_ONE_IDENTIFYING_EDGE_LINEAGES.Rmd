...
ex_PD_full <- merge(ex_PD_full, family.iter, by = "Family")
...
EDGE_priority_lineages <- EDGE_priority_lineages[which(EDGE_priority_lineages$unassessed_prop < 0.10),] 
...
EDGE_priority_lineages$priority_type[EDGE_priority_lineages$unassessed_prop == 0 & EDGE_priority_lineages$assessed_threat_prop == 1] <- "Priority lineage"

EDGE_priority_lineages$priority_type[EDGE_priority_lineages$unassessed_prop > 0 & EDGE_priority_lineages$assessed_threat_prop == 1] <- "Research lineage"

EDGE_priority_lineages$priority_type[EDGE_priority_lineages$unassessed_prop > 10 & EDGE_priority_lineages$assessed_threat_prop < 1]<- "Watchlist lineage"
