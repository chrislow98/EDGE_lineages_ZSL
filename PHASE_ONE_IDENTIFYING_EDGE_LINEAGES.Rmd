...
t <- EDGE_priority_lineages[which(EDGE_priority_lineages$no_DD_NE_prop < 0.2),] 
...
EDGE_priority_lineages$priority_type[EDGE_priority_lineages$no_DD_NE_prop < 0.1 & EDGE_priority_lineages$assessed_threat_prop == 1] <- "Priority lineage"

EDGE_priority_lineages$priority_type[EDGE_priority_lineages$unassessed_prop > 0.1 | EDGE_priority_lineages$assessed_threat_prop < 1]<- "Watchlist lineage"

EDGE_priority_lineages$priority_type[EDGE_priority_lineages$unassessed_prop > 0.1 & EDGE_priority_lineages$assessed_threat_prop == 1] <- "Research lineage"
